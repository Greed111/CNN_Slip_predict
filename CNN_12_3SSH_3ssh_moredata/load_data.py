...
if __name__ == '__main__':
      ...
      testts = my_dataset(data_x_test, data_y_test, 26)
      train_data_size = len(testtr)
      test_data_size = len(testts)
      print("测试数据集的长度为：{}".format(test_data_size))
      x1 ,x2 = testtr.predict_ssh(30)  # 范围在1~43
